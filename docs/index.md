...
<style>
  ...
  .course-card .icon { font-size: 52px; line-height: 1.2; margin-bottom: 6px; }
  .course-card h3 { font-size: 18px; margin: 4px 0 5px; color: #333; font-weight: 700; }
  ...
  .view-all:hover { transform: scale(1.05); box-shadow: 0 6px 20px rgba(255,179,71,0.5); }
  ...
  @media (max-width: 600px) {
    .play-header h1 { font-size: 1.8rem; }
...
## 🎵 童谣 <span class="sparkle-star">⭐</span><span class="sparkle-star">⭐</span><span class="sparkle-star">⭐</span>

<div class="section-divider"></div>

<div class="course-grid">

  <a href="courseware/twinkle-twinkle.html" style="text-decoration:none;color:inherit">
    <div class="course-card card-purple card-new">
      ...
      <p>一闪一闪亮晶晶！🎵 钢琴声旋律<br>拼单词+找星星互动游戏</p>
      <span class="btn-start">🎵 听儿歌</span>
    </div>
  </a>

  <a href="courseware/old-macdonald.html" style="text-decoration:none;color:inherit">
    <div class="course-card card-orange card-new">
      ...
      <p>E-I-E-I-O！听声音配对动物<br>认识 cow/pig/duck 和叫声</p>
      <span class="btn-start">🎵 听儿歌</span>
    </div>
  </a>
...
<div class="course-grid">
  ...
  <a href="courseware/phonics-fat-cat.html" style="text-decoration:none;color:inherit">
    <div class="course-card card-green">
      ...
      <div class="tags">
        <span class="tag tag-green">🔤 拼读</span>
      </div>
      <p>Usborne风格拼读故事<br>每页拼词互动学发音</p>
  ...
  <a href="courseware/elephant-piggie-surprise.html" style="text-decoration:none;color:inherit">
    <div class="course-card card-purple">
      ...
      <div class="tags">
        <span class="tag tag-purple">💬 故事</span>
      </div>
      <p>角色对话 + 情绪选择游戏<br>Elephant & Piggie 风格</p>
...
<div class="course-grid">
  ...
  <a href="courseware/gears-transmission.html" style="text-decoration:none;color:inherit">
    <div class="course-card card-red">
      ...
      <p>点齿轮、转链条、修机器人！<br>认识神奇的传动世界</p>
      <span class="btn-start">⚙️ 开始玩</span>
    </div>
  </a>

  <a href="courseware/rainforest-adventure.html" style="text-decoration:none;color:inherit">
    <div class="course-card card-orange">
      ...
      <p>点一点探索雨林！<br>认识树懒/鹦鹉/蝴蝶等6种生物</p>
...
<div style="text-align:center;margin:20px 0">
  <a href="courseware/" class="view-all">📚 查看全部课件 →</a>
</div>

---

> 👆 点击卡片开始学习之旅！每堂课都有语音朗读 🔊 和互动游戏 🎮，小朋友可以自己点着玩。
> 新课件持续更新中，常回来看看哦！ <span class="sparkle-star">⭐</span><span class="sparkle-star">⭐</span><span class="sparkle-star">⭐</span>
